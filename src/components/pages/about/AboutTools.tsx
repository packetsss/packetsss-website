			...
			<Card.Body>
				<blockquote className="blockquote mb-0">
					<p style={{ textAlign: "justify" }}>
						A sophomore at UC San Diego who love Machine Learning
						and always looking forward to learn new stuff.
						<br />
						<br />
						Apart from coding, these are some other activities who
						enjoys doing!
					</p>
					<ul>
...
function LaughterHook() {
	...
	return (
		<div>
			<button
				onClick={() => {setCount(count + 1); setText(text + "ol")}}
